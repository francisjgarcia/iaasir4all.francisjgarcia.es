...
<body>
    <div style="display: flex; align-items: center; justify-content: center; position: absolute; width: 100% !important; height: 100% !important">
            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="error-text">
                        ...
                        <h4>¡Uy! Esta página no se pudo encontrar!</h4>
                        <p>Lo sentimos, la página que estás buscando no existe, se eliminó o se cambió el nombre.</p>
                        <a href="/" class="btn btn-primary btn-round">Volver al inicio</a>
                    </div>
                </div>
            </div>
        </div>
