  ...
  if(isset($_SESSION["servicio"]) && $_SESSION["servicio"][1] == "apache" && $_POST["apache"] != "eliminar") {
    ...
    <div class="col-md-12 fjg-servicio" id="apache" style="padding-top: 10px">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-4">
          <label for="Crear CMS">Crear CMS</label>
          <select class="form-control" name="apache_cms" id="apache_cms" required>
...
<div class="col-md-12 fjg-servicio" id="apache" style="padding-top: 10px">
  ...
  if (isset($_SESSION["servicio"][1]) || $_SESSION["servicio"][2] || $_SESSION["servicio"][3] || $_SESSION["servicio"][4] || $_SESSION["servicio"][5] || $_SESSION["servicio"][6] ) {
    ...
    <button class="btn btn-block btn-success btn-final" type="submit">
      <span class="glyphicon glyphicon-cloud-download"></span>Desplegar servicios »
    </button>
    <?php
  }
  ?>
...
if(isset($_SESSION["servicio"]) && $_SESSION["servicio"][1] == "apache" && isset($_POST["apache_puerto"]) && isset($_POST["apache_dominio"]) && isset($_POST["apache_documentroot"])) {
  ...
  exec('mkdir -p /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios/apache');
  exec('echo puerto: '.$_POST["apache_puerto"].' > /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios/apache/vars.yml');
  ...
  exec('cp -R /hdd-ext/aprovisionamiento/ansible/web/apache/* /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios/apache');

if(isset($_SESSION["infraestructura"]) && $_SESSION["infraestructura"] == "baremetal") {
  if($_POST["apache_cms"] == "wordpress") {
    exec('sudo ansible-playbook -i /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/infraestructura/hosts /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios/apache/apache_wordpress.yml &');
    exec('sudo ssh -i /hdd-ext/usuarios/'.$_SESSION["username"].'/ssh_keys/'.$_SESSION["baremetal"][3].' '.$_SESSION["baremetal"][1].' -p '.$_SESSION["baremetal"][2].' "systemctl restart apache2"');
  }
  else {
...
if(isset($_SESSION["infraestructura"]) && $_SESSION["infraestructura"] == "vagrant") {
  exec('echo apache >> /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios.tmp');
  

  if($_SESSION["numero_servicios"] = 1) {
    exec('mkdir -p /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/scripts');

  exec('cp -R /hdd-ext/aprovisionamiento/vagrant/scripts/* /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/scripts');

    exec('sudo /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/scripts/remote_vagrant.sh &');
  }
...
if(isset($_SESSION["servicio"]) && $_SESSION["servicio"][2] == "nginx" && isset($_POST["nginx_puerto"]) && isset($_POST["nginx_dominio"]) && isset($_POST["nginx_documentroot"])) {
  ...
  exec('echo puerto: '.$_POST["nginx_puerto"].' > /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios/nginx/vars.yml');
...
if(isset($_SESSION["infraestructura"]) && $_SESSION["infraestructura"] == "vagrant") {
  exec('echo nginx >> /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios.tmp');
  

  if($_SESSION["numero_servicios"] = 2) {
    exec('mkdir -p /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/scripts');
...
if(isset($_SESSION["infraestructura"]) && $_SESSION["infraestructura"] == "vagrant") {
  exec('echo vsftpd >> /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios.tmp');
  

  if($_SESSION["numero_servicios"] = 3) {
    exec('mkdir -p /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/scripts');
...
if(isset($_SESSION["infraestructura"]) && $_SESSION["infraestructura"] == "vagrant") {
  exec('echo mysql >> /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios.tmp');
  

  if($_SESSION["numero_servicios"] = 4) {
    exec('mkdir -p /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/scripts');
...
if(isset($_SESSION["infraestructura"]) && $_SESSION["infraestructura"] == "vagrant") {
  exec('echo postgresql >> /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios.tmp');
  

  if($_SESSION["numero_servicios"] = 5) {
    exec('mkdir -p /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/scripts');
...
if(isset($_SESSION["infraestructura"]) && $_SESSION["infraestructura"] == "vagrant") {
  exec('echo postfix >> /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/servicios.tmp');
  

  if($_SESSION["numero_servicios"] = 6) {
    exec('mkdir -p /hdd-ext/usuarios/'.$_SESSION["username"].'/historial/'.$_SESSION["fecha_despliegue"].'/scripts');
